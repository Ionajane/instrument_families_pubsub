...
Instruments.prototype.bindEvents = function () {
  PubSub.publish('Instruments:all-instruments-ready', instrumentFamilies);
  ...
  Instruments.prototype.publishFamilyDetail = function (familyIndex) {
    const selectedFamily = this.instrumentFamilies[familyIndex];
    PubSub.publish('Instruments:selected-family-ready', selectedFamily)
  };
